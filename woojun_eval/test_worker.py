...
class WorkerTest:
    def __init__(self, metaAgentID, localNetwork, global_step, budget_range, sample_length=None, device='cuda', greedy=False, save_image=False, seed=None, multigamma=False):
        self.device = device
        self.greedy = True
        ...
        self.seed = seed
        self.env = Env(sample_size=SAMPLE_SIZE, start=(0,0), destination=(1,1), k_size=K_SIZE, budget_range=budget_range, save_image=self.save_image, seed=seed, fixed_env=FIXED_ENV)
