...
from parameters import ADAPTIVE_TH
...
class RAOr:
    ...
    def plot(self, route, n1, n2):
        ...
        plt.suptitle(
            "Budget: {:.4g}/{:.4g},  RMSE: {:.4g}, F1score:{:.4g}, CovTrace:{:.4g}".format(
                self.env.budget,
                self.budget0,
                self.env.gp_ipp.evaluate_RMSE(self.env.ground_truth),
...
if __name__ == "__main__":
    ...
    for j in range(NUM_REPEAT):
        for i in range(NUM_TEST):
            print("Loop:", j, i)
            seed = (i + 1) * 100 + 1
            raor = RAOr(sample_size=100, seed=seed, show_img=False)
